  ...
  return (
    <div className="p-4 sm:p-8 h-full">
      <div className="mb-6 sm:mb-8">
        <h1 className="text-xl sm:text-3xl font-bold text-textPrimary mb-1 sm:mb-2">Welcome Back</h1>
        <p className="text-sm text-textSecondary">Here's the current state of your second brain.</p>
      </div>
